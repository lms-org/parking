...
public:
    ...
    void convolution(std::vector<double> *in, std::vector<double> *out, int dataSize, std::vector<double> *kernel, const int kernelSize, const int numSkip);
    void findEdges(std::vector<double> *dst, std::vector<double> *x, std::vector<double> *edgePosition, std::vector<double> *edgeType);
